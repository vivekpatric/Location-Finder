			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="RgistrationServlet" class="register-form"
							id="register-form">
...
<script type="text/javascript">
	...
	}else if(status=="invalidMobileNumberLength"){
		swal("Sorry","Mobile number must be 10 digits","error");
	}
